...
public class D1Tests {
    ...
    static <T> T useFile(Function<List<String>, T> test) throws IOException {
        return test.apply(Files.readAllLines(Inputs.of("d1i1.txt")));
    }

    @Test
    public void test1() throws IOException {
        assertThat(D1Tests.<Long>useFile(lines -> D1.findSum(lines))).isEqualTo(502);
    }
    ...
    public void test2Sample() throws IOException {
        ...
        assertThat(D1Tests.<Long>useFile(lines ->
